...
// data members to the first argument.
  TimeInterval(const TimeOfDay& s, const TimeOfDay& e);
...
// of the start TimeOfDay data member.
  TimeInterval(const TimeOfDay& s, int l, string u);
...
void SetStartTime(const TimeOfDay& s);
...
// TimeOfDay data member unchanged.
void SetEndTime(const TimeOfDay& e);
...
void SetEndTime(int l, string u);
...
// TimeOfDay data members.
  void Print(bool military = false, bool seconds = false);
